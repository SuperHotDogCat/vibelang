...
declare i64 @printf(ptr, i64, i64, i64, ...)
...
entry:
  ...
  call void @Vector_init(ptr %v, i64 10)
  call void @Vector_push(ptr %v, i64 100)
  call void @Vector_push(ptr %v, i64 200)
  %s = alloca %HashSet, align 8
  call void @HashSet_init(ptr %s, i64 5)
  call void @HashSet_add(ptr %s, i64 1)
  call void @HashSet_add(ptr %s, i64 2)
  %0 = call i64 @Vector_get(ptr %v, i64 0)
  %1 = icmp eq i64 %0, 100
